...
fig = plt.hist(img.ravel(),256,[0,256],facecolor = 'gray')
...
fig1 = plt.hist(img1[ : , : , 0:1].ravel(),256,[0,256],facecolor = 'blue')
...
fig2 = plt.hist(img1[ : , : , 1:2].ravel(),256,[0,256],facecolor = 'green')
...
fig3 = plt.hist(img1[ : , : , 2:3].ravel(),256,[0,256],facecolor = 'red')
